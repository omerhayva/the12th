...
export default function MatchPage({ params }: { params: { id: string } }) {
  ...
  const submitDecision = async () => {
    if (!selected || locked || !activeWindow || activeWindow.resolved || submitting) return;
    setSubmitting(true);
    setSubmitError(null);
    ...
    try {
      ...
      setSubmitError(error instanceof Error ? error.message : 'KARAR KAYDEDİLEMEDİ');
    } finally {
      setSubmitting(false);
    }
  };
